<section class="zelan mt-24 px-6 w-full h-screen">
    <h1 class="mb-10 pt-6 text-center zelan text-yellow-600 text-6xl">
        እዚህ ያግኙን
    </h1>
    ...
    <div class="px-5 grid gap-8 grid-cols-1 md:grid-cols-2 py-4 mx-auto text-gray-900 rounded-lg">
        <div class="flex flex-col justify-center">
          ...
          <a class="underline" href="mailto:someone@gmail.com"> email </a>
          instead.
        </div> -->
            </div>
            <div class="mt-12 text-center relative">
                <img class="bg-cover object-contain rounded-lg" src="/images/marathon-1.jpg" alt="Contact" />
                <div
                    class="px-4 py-4 absolute top-5 left-5 flex items-center justify-start bg-green-50 rounded-lg opacity-75">
                    <svg class="w-16 h-16 text-yellow-600" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                        <path
                    ...
                    <div class="flex flex-col justify-start items-start">
                        <p class="text-2xl">መገናኛ ፣ ማራቶን ህንጻ 6ተኛ ፎቅ</p>
                    </div>
                </div>
            </div>
        </div>
